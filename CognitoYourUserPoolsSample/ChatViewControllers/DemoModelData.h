...
static NSString * const kJSQDemoAvatarDisplayNameCook = @"Tim";
static NSString * const kJSQDemoAvatarDisplayNameJobs = @"John";
static NSString * const kJSQDemoAvatarDisplayNameWoz = @"Phill";
